 ...
 */
std::unordered_map<std::string, std::string> build_map(std::ifstream &map_file)
{
    std::unordered_map<std::string, std::string> trans_map; // 转换规则
    std::string key;
    std::string value;
 ...
 */
const std::string &transform(const std::string &s, const std::unordered_map<std::string, std::string> &rules)
{
